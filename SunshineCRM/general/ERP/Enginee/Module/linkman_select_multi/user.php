...
if($_GET['action']=="SEARCH")	{
	...
	$AddSql = $AddSql." and (a.supplyname like '%$KEYVALUE%' or a.calling like '%$KEYVALUE%'  or b.linkmanname like '%$KEYVALUE%' or b.linkmanpy like '%$KEYVALUE%')";
}

echo "<table class=\"TableBlock\" width=\"100%\"><tr class=TableHeader>  <td align=\"center\"><b>客户</b></td><td align=center><b>联系人</b></td><td align=center>$showfield</td>\r\n</tr>\r\n\r\n";

$sql = "select a.supplyname,b.linkmanname,b.$showfield,b.rowid from customer a inner join linkman b on a.rowid=b.customerid $AddSql order by supplyname,linkmanname";
