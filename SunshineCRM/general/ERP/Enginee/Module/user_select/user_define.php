...
$query = "SELECT USER_ID,USER_NAME,DEPT_NAME from USER,DEPARTMENT where USER.DEPT_ID=DEPARTMENT.DEPT_ID and NOT_LOGIN!='1' and find_in_set(USER_ID,'".$USER_STR."')";
$cursor = exequery( $connection, $query );
