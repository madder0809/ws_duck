...
$(document).ready(function(){
	reloadTree("1");
	parent.user.location="user.php?seldeptid=<?php echo $_SESSION['LOGIN_DEPT_ID']?>&FORM_NAME=<?php echo $FORM_NAME?>&TO_ID=<?php echo $TO_ID?>&TO_NAME=<?php echo $TO_NAME?>&MODULE_ID=<?php echo $MODULE_ID?>";
});
...
function zTreeOnChange(event, treeId, treeNode) {
	...
	parent.user.location="user.php?seldeptid="+ids+"&FORM_NAME=<?php echo $FORM_NAME?>&TO_ID=<?php echo $TO_ID?>&TO_NAME=<?php echo $TO_NAME?>&MODULE_ID=<?php echo $MODULE_ID?>";
}
