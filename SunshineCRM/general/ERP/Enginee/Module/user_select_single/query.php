...
$query="SELECT USER_ID,USER_NAME from user,user_priv where USER.USER_PRIV=USER_PRIV.USER_PRIV";
if ( $DEPT_ID != "" )
...
if($USER_NAME!="")
	$query.=" and (USER_NAME like'%".$USER_NAME."%' or USER_ID like '%".$USER_NAME."%')";
//print $query;
