		...
		if(key!=kword.value )
		{
	     key=kword.value;
		   ...
		   if($('search_icon').src.indexOf("../../../Framework/images/quicksearch.gif")>=0)
		   {
		   	   ...
		   	   $('search_icon').onclick=function(){kword.value='按计划安排名称搜索...';$('search_icon').src="../../../Framework/images/quicksearch.gif";$('search_icon').title="";$('search_icon').onclick=null;};
		   }
	  }
...
<table border="0" cellspacing="1" width="100%" class="small"  cellpadding="2" align="center">
 ...
 <div style="border:1px solid #000000;margin-left:2px;background:#FFFFFF;width:220px;">
  <input type="text" id="kword" name="kword" value="按计划安排名称搜索..." onfocus="ctroltime=setTimeout(CheckSend,100);" onblur="clearTimeout(ctroltime);if(this.value=='')this.value='按计划安排名称搜索...';" class="SmallInput" style="border:0px; color:#A0A0A0;width:190px;" ><img id="search_icon" src="../../../Framework/images/quicksearch.gif" align=absmiddle style="cursor:pointer;">
</div>
<td align="left">
 <input type="button" class="SmallButton" value="清 空" onclick="clear_user();">
 <input type="button" class="SmallButton" value="关 闭" onclick="parent.window.close();">
 </td></tr></table>
 </body></html>