...
echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=gb2312\">\r\n\r\n</head>\r\n<frameset rows=\"30,*\"  rows=\"*\" frameborder=\"NO\" border=\"0\" framespacing=\"0\">\r\n
 <frame name=\"control\" scrolling=\"no\" src=\"control.php?showfield=$showfield&TO_ID=";
echo $TO_ID;
echo "&TO_NAME=";
echo $TO_NAME;
echo "&MANAGE_FLAG=";
...
echo "&FORM_NAME=";
echo $FORM_NAME;
echo "\">\r\n <frame name=\"user\" src=\"user.php?showfield=$showfield&TO_ID=";
echo $TO_ID;
echo "&TO_NAME=";
echo $TO_NAME;
echo "&MANAGE_FLAG=";
