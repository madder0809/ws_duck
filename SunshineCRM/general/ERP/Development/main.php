...
$INIT_ARRAY = array("init","view","edit","add","delete","report","statistics","import","export");
...
//ADD、EDIT、INIT视图显示模块
//##############################################################################
if($actionModel=="add"||$actionModel=="edit"||$actionModel=="view")				{
	$GlobalModel = $actionModel;
	sectionName1();
	$sectionArray = $file_ini[(String)$_GET['sectionName']];
	//print_R($sectionArray);
