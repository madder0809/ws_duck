...
<body>
<iframe id="table_main" name="table_main" src="../Interface/CRM/erp_mytable/crm_mytable.php" scrolling=yes frameborder="0" width="100%"  height="100%" marginwidth="0" marginheight="0" ></iframe>
