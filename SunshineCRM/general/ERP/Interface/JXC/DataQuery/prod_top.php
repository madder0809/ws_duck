...
<div align=left  style="margin: 10px;">
方法二：<input type="button" id="btn" value="开启条码输入" onclick = "if(this.value=='开启条码输入')show('fd');else closeed('fd');">
...
产品条码：<input type="text" id="inputcode" name="inputcode" value=""  class="SmallInput" style="width:120px" onkeydown="if(event.keyCode==13){addProduct(this.value,'add',2,inputnum.value);this.value='';}" onkeyup="if(event.keyCode==107 || event.keyCode==187){this.value='';inputnum.select();}"><br>
(按+键可编辑数量)
 </div> 
</div>
</div>
