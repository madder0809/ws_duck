...
function updateSellPrice(id, newprice)
{
	...
	{
		sendRequest("&action=updateSellPrice&id="+id+"&price="+newprice);
	}
...
function ajaxFileUpload()
{
   ...
   $$.ajaxFileUpload({
             url:'buyplanmain_mingxi_newai.php?action=import_default_data', 
             secureuri:false,
...
<TR><TD  class=TableHeader height=30>&nbsp;采购单明细录入&nbsp;（<?php echo $customerName?>，采购总额 <font color=red><?php echo $totalmoney?></font> 元）</TD></TR>
</table>
<div id="shoppingcart">
</div>
<div id="inputarea">
...
<input type='button' id='btnimport' value='导入' class='SmallButton' onclick='ajaxFileUpload()'>&nbsp;<a href="buyplanmain_mingxi_newai.php?action=export_default_data&exportfield=<?php echo $showlistfieldlist?>&tablename=buyplanmain_mingxi&searchfield=1&searchvalue=0">下载模版(请把单号列设为 <font color=red><?php echo $rowid?></font> )</a></TD>
