    		...
    		var doc = new ActiveXObject(\"MSxml2.DOMDocument\");
  			...
  			var sum = rootnode.childNodes[1].childNodes[0].nodeValue;
   		 	document.getElementById('integral').innerText=integral+' 分';	
   		  	document.getElementById('sum').innerText=sum+' 分';
    }
}
";
	...
	print "&nbsp;<input type=\"button\" title='' value=\"选择\" class=\"SmallButton\" onClick=\"var oldid=".$fieldname1."_ID.value; SelectAllInforSingle('../../Enginee/Module/kehu_select_single/index.php','','".$fieldname1."_ID', '$fieldname1');if(oldid!=".$fieldname1."_ID.value){sendRequest(".$fieldname1.".value)};\" >&nbsp;";
