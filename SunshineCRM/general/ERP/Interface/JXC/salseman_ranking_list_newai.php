...
$head=array("name"=>"导购员","num"=>"订单数量","totalmoney"=>"交易金额","huikuanjine"=>"回款金额","fahuojine"=>"发货金额","kaipiaojine"=>"开票金额");
...
chart_index.setDataXML("<graph bgcolor='e1f5ff' caption='销售员排行' subCaption='精确到百位（四舍五入）' numberPrefix='' formatNumberScale='1' decimalPrecision='2' baseFontSize='14' numberSuffix='万元'><?php foreach ($rs_a as $row){echo "<set name='".$row['name']."' value='".($row['totalmoney']/10000)."'/>";}?></graph>");
