<?php
	...
	if($_GET['action']=="add_default_data" || $_GET['action']=="edit_default_data")
	{
		...
		if($_GET['action']=="add_default_data")
		{
			...
			$sql="insert into sellplanmain_detail (id,mainrowid,prodid,prodname,price,num,jine,zhekou,beizhu,plandate,qici,yaoqiu,iftixing,createtime) values(".$maxid.",".$mainrowid.",'".
			$prodid."','".$prodname."',".$price.",".$num.",".$jine.",1,'".$beizhu."','".$plandate."','".$qici."','".$yaoqiu."','".$iftixing."','".$createtime."')";
			$opertype="新增";
		}
		else 
		{
