<?php
	...
	page_css("确认发货单");
	global $db;
	$sql="select * from fahuodan where billid=".$billid;
	$rs=$db->Execute($sql);
	$rs_a = $rs->GetArray();	
...
<td nowrap>产品编号</td><td nowrap>名称</td><td nowrap>规格</td><td nowrap>型号</td><td nowrap>单位</td><td nowrap>单价</td><td nowrap>折扣</td><td nowrap>数量</td><td nowrap>金额</td><td nowrap>备注</td></tr>
<?php 
