...
if ( $_GET['action'] == "" || $_GET['action'] == "init" )
{
	...
	print_title("积分设置");
	print_tr( "1个积分对应金额:", "integral", $ini_file[section][integral], 25, 1, "SmallInput", "" );
	...
	print_tr( "纸张宽度(mm):", "width", $ini_file[paper_size][width], 25, 1, "SmallInput", "" );
	print_tr( "纸张高度(mm):", "height", $ini_file[paper_size][height], 25, 1, "SmallInput", "" );
