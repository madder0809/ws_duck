...
if(count($rs_a)>0){
   for($i=0;$i<count($rs_a);$i++){
	   ...
	   $module_body .= "<tr class=\"TableBlock\">
						<td><img src=\"../images/arrow_r.gif\" align=\"absmiddle\"><a href=../../JXC/customer_newai.php?".base64_encode("action=view_default&ROWID=".$rs_a[$i]['客户名称'])." target=_blank title='$title'>".$customerName."</td>
						<td valign=\"Middle\" align=\"right\">".$servicetype."</td>
						<td valign=\"Middle\" align=\"right\"><a href=../../JXC/crm_service_newai.php?".base64_encode("action=init_default_search&searchfield=编号&searchvalue=".$编号)." target=_blank>".$servicestate."</a></td>
						<td valign=Middle align=right>[<a href=../../Framework/user_newai.php?".base64_encode("action=view_default&UID=".$userinfo['UID'])." target=_blank>".$userinfo['USER_NAME']."</a>]</td>
