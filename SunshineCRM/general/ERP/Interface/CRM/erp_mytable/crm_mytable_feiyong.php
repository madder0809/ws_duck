...
if(count($rs_a)>0){
  ...
  for($i=0;$i<count($rs_a);$i++){
	 ...
	 $module_body .= "<tr class=TableBlock>
						...
						<td valign=Middle align=left><a href=../crm_feiyong_sq_newai.php?".base64_encode("action=view_default&单号=$单号")." target=_blank>金额:".$rs_a[$i]['金额']."</a></td>
						<td valign=Middle align=right>$shenhe</td>
						<td valign=Middle align=right>".$feiyongname."</td>
