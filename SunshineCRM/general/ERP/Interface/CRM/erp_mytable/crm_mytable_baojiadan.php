...
if(count($rs_a)>0){
  ...
  for($i=0;$i<count($rs_a);$i++){
	 ...
	 $module_body .= "<tr class=TableBlock>
						...
						<td valign=Middle align=left><a href=../../JXC/customerproduct_newai.php?".base64_encode("action=view_default&ROWID=$单号")." target=_blank>".$rs_a[$i]['主题']."</a></td>
						<td valign=Middle align=right>金额:".$rs_a[$i]['金额']."</td>
