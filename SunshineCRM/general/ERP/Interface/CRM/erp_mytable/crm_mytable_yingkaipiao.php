...
$sql = "select * from v_yingkaipiaohuizong where 1=1 ";
...
if(count($rs_a)>0){
   for($i=0;$i<count($rs_a);$i++){
	   ...
	   $huikuan=number_format($rs_a[$i]['kaipiaojine'],2);
	   ...
	   $module_body .= "<tr class=\"TableBlock\">
						...
						<td><a href='../../JXC/v_yingkaipiaohuizong_mingxi.php?".base64_encode("supplyid=$rowid")."' target='_blank'>单数:".$num."</a></td>
						<td valign=\"Middle\" align=\"left\">金额:".$own."</td>
						<td valign=\"Middle\" align=\"left\">已开:".$huikuan."</td>
						<td valign=\"Middle\" align=\"left\">待开:".$pay_own."</td>
					  </tr>";
