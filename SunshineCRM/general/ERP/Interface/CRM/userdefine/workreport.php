...
function changelocation1()
{
    ...
    sendRequest('huizong','id='+document.getElementById('workdate').value);
}
...
<img src='/general/ERP/Framework/images/menu/calendar.gif' width=16 height=16 title='设置日期' align='absMiddle' border='0' align='absMiddle' style='cursor:pointer' onclick='workdate.click();'></TD></TR>";
